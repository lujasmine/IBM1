...
PIO_STORAGE_SOURCES_PGSQL_URL=jdbc:postgresql://qdjjtnkv.db.elephantsql.com:5432/sfaupawb
PIO_STORAGE_SOURCES_PGSQL_USERNAME=sfaupawb
PIO_STORAGE_SOURCES_PGSQL_PASSWORD=9-pVv4cOcih6kuZMmbDUZU32Qg-U6-eO
...
PIO_STORAGE_SOURCES_HDFS_PATH=$PIO_FS_BASEDIR/models
